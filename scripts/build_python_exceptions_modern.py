# scripts/build_python_exceptions_modern.py
import os

BASE_DIR = r"D:\Projects\knowledgebase"

PY_EXCEPTIONS_TYPING = """# Python Exception Handling, Type Hints & Modern Features (Python 3.10+)
...
with open(os.path.join(BASE_DIR, "08-backend-python-fastapi", "07_python_exceptions_typing_and_modern_features.md"), "w", encoding="utf-8") as f:
    f.write(PY_EXCEPTIONS_TYPING.strip() + "\n")
print("Created 07_python_exceptions_typing_and_modern_features.md")
