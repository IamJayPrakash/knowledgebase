...
// Strategy: Postorder DFS computing max gain per branch

function solution_124(inputData) {
    ...
    for (let i = 0; i < inputData.length; i++) {
        ...
        // Step 3: Validate optimal criteria based on Postorder DFS computing max gain per branch
...
def solution_124(input_data):
    # Step 1: Initialize required data structure or pointers for Postorder DFS computing max gain per branch
    state = {}
