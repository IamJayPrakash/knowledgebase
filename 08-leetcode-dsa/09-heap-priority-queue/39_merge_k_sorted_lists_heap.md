...
// Strategy: Min-heap storing k node heads
...
function solution_23(inputData) {
    ...
    for (let i = 0; i < inputData.length; i++) {
        ...
        // Step 3: Validate optimal criteria based on Min-heap storing k node heads
...
def solution_23(input_data):
    # Step 1: Initialize required data structure or pointers for Min-heap storing k node heads
    state = {}
